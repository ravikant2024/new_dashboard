...
import { createReview, deleteReviewById, fetchAllReviews, fetchReviewsByProductId, updateReviewById } from './ReviewApi'
...
export const fetchAllReviewsAsync = createAsyncThunk('review/fetchAllReviewssync', async () => {
...
const reviewSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            // Added fetchAllReviewsAsync handlers here
            ...
            .addCase(fetchAllReviewsAsync.rejected, (state, action) => {
                state.reviewFetchStatus = 'rejected'
                state.errors = action.error.message || action.error
            })
