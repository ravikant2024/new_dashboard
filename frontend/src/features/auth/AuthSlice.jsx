...
import { signup, login, resendOtp, verifyOtp, resetPassword, forgotPassword, logout, checkAuth } from "./AuthApi";
// Initial state
const initialState = {
    status: "idle",
    errors: null,
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(logoutAsync.fulfilled, (state) => {
                ...
                state.loggedInUser = {
                    _id: import.meta.env.VITE_GUESTUSER_ID,
                    email: import.meta.env.VITE_GUESTUSER_EMAIL,
                    isVerified: import.meta.env.VITE_GUESTUSER_IS_VERIFIED,
                    isAdmin: import.meta.env.VITE_GUESTUSER_IS_ADMIN
                };
...
// exporting reducers
export const { clearAuthSuccessMessage, clearAuthErrors, resetAuthStatus,
    clearSignupError, resetSignupStatus, clearLoginError, resetLoginStatus,
    clearOtpVerificationError, resetOtpVerificationStatus, clearResendOtpError,
    clearResendOtpSuccessMessage, resetResendOtpStatus, clearForgotPasswordError,
    clearForgotPasswordSuccessMessage, resetForgotPasswordStatus,
    clearResetPasswordError, clearResetPasswordSuccessMessage,
    resetResetPasswordStatus } = authSlice.actions
